<template>
  <div class="custom-container">
    <div class="max-w-3xl px-5">
      <h1 class="custom-header">プライバシーポリシー</h1>
      <p class="mt-8">
        Kickoff Reminder（以下、「当事務局」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めております。
      </p>
      ...
      <p>
        ...
        <a
          ...
          class="underline"
        >
          LogRocketプライバシポリシーをご覧ください。</a
        >
      </p>

      <h2 class="section-title">第5条（利用目的の変更）</h2>
      <ol class="section-list">
        <li>
      ...
      <ol class="section-list">
        <li>
          ...
          <ol class="section-list">
            <li>人の生命、財産の保護の必要があるとき</li>
            <li>公衆衛生の向上または児童の健全な育成の推進に必要であるとき</li>
            <li>
